...
export class Course {
    ...
    constructor(department: string, courseNumber: number, credits: number, minGrade: Grade,
        prerequisites: Prereq.Prerequisite, description: string = "") {
...
export const CS321: Course = new Course("CS", 321, 3, Grade.C, new Prereq.And(
